...
//
//        // test1 test2 둘다 검색
//        List<FeedTag> feeds3 = feedTagRepository.findAllByTag(saveTag);
//
...
//    }
    ...
    @Autowired
    FeedTagRepositoryImpl repository;
    ...
    public void test(){
        ...
        list.add("finally");
        list.add("한");
        List<FeedTag> feedTags = repository.searchByTags(feedConverter.toTagEntity(list));
        System.out.println(feedTags);
    }
}
